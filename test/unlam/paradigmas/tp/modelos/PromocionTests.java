...
public class PromocionTests {
	...
	public void leeUnaPromocionPorcentual() {
		...
		List<Promocion> promocionObtenida = new Archivo().getPromocionesArchivoRuta("entrada/promocionPorcentual.txt",
				atraccionesEjemplo);
	...
	public void leeUnaPromocionAbsoluta() {
		...
		List<Promocion> promocionObtenida = new Archivo().getPromocionesArchivoRuta("entrada/promocionAbsoluta.txt",
				atraccionesEjemplo);
	...
	public void leeUnaPromocionCombo() {
		...
		List<Promocion> promocionObtenida = new Archivo().getPromocionesArchivoRuta("entrada/promocionCombo.txt",
				atraccionesEjemplo);
